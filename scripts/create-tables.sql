...
CREATE INDEX idx_events_employer_id ON events(employer_id);
CREATE INDEX idx_events_date ON events(event_date);
CREATE INDEX idx_events_status ON events(status);
CREATE INDEX idx_event_workers_event_id ON event_workers(event_id);
CREATE INDEX idx_event_workers_worker_id ON event_workers(worker_id);
CREATE INDEX idx_ratings_event_id ON ratings(event_id);
CREATE INDEX idx_messages_sender_id ON messages(sender_id);
CREATE INDEX idx_messages_receiver_id ON messages(receiver_id);
CREATE INDEX idx_payments_event_worker_id ON payments(event_worker_id);
